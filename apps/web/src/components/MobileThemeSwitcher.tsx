...
export const MobileThemeSwitcher: React.FC = () => {
  ...
  return (
    <fieldset className="flex h-8 p-0 m-0 rounded-full border border-border bg-background/80">
      ...
      <div className="mt-[-1px] ml-[-1px]">
        ...
        <label
          ...
          className={clsx(
            "flex items-center justify-center h-8 w-8 cursor-pointer rounded-full group",
            theme === "system" && "border-r border-border bg-accent/40"
          )}
        >
          ...
          <svg height="16" viewBox="0 0 16 16" width="16">
            <path
              ...
              className={clsx(
                "duration-150",
                theme === "system" ? "fill-foreground" : "fill-muted-foreground"
              )}
            />
          </svg>
        </label>
      ...
      <div className="mt-[-1px]">
        ...
        <label
          ...
          className={clsx(
            "flex items-center justify-center h-8 w-8 cursor-pointer rounded-full group",
            theme === "light" && "border border-border bg-accent/40"
          )}
        >
          ...
          <svg height="16" viewBox="0 0 16 16" width="16">
            <path
              ...
              className={clsx(
                "duration-150",
                theme === "light" ? "fill-foreground" : "fill-muted-foreground"
              )}
            />
          </svg>
        </label>
      ...
      <div className="mt-[-1px] mr-[-1px]">
        ...
        <label
          ...
          className={clsx(
            "flex items-center justify-center h-8 w-8 cursor-pointer rounded-full group",
            theme === "dark" && "border-l border-border bg-accent/40"
          )}
        >
          ...
          <svg height="16" viewBox="0 0 16 16" width="16">
            <path
              ...
              className={clsx(
                "duration-150",
                theme === "dark" ? "fill-foreground" : "fill-muted-foreground"
              )}
            />
          </svg>
        </label>
